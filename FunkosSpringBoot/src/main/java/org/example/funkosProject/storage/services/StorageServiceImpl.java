...
import org.example.funkosProject.storage.controllers.StorageController;
            ...
            Files.walk(rootLocation)
                    ...
                    .forEach(file -> {
                        try {
                            ...
                            throw new StorageException("Error al eliminar el fichero " + file);
                        }
                    });
        } catch (IOException e) {
            throw new StorageException("Error al eliminar los ficheros " + e);
        }
    }
